...
from species.data_loader import dset_classes, dset_loaders, dset_sizes, dsets, transform
...
if __name__ == '__main__':
    model = CNNModel()
    model.cuda().load_state_dict(torch.load('results/species/build_model_species.pkl'))
    model.eval()
